...
## Related Files
- [Claude Client](Claude%20Client.md) - Client-side requirements and capabilities
- [02 - Core Architecture](../02%20-%20Core%20Architecture.md) - Overall system architecture
- [T-API Gateway](../MCP%20Servers/T-API%20Gateway/README.md) - T-API Gateway server
- [Optical Specialist](../MCP%20Servers/Optical%20Specialist/README.md) - Optical Specialist server
- [Lab Manager](../MCP%20Servers/Lab%20Manager/README.md) - Lab Manager server
