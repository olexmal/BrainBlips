...
sidebar_position: 4
description: AI Copilot for software developers and testers with lab management and knowledge base integration for accelerated development workflows
tags: [development, testing, lab-management]
keywords: [development copilot, testing, lab manager, emulator, software development, api testing]
---
...
:::tip Server Role: Lab Environment Manager
This server manages the development and test lab environment, providing emulator access and configuration tools.
:::
...
- **Issue Reproduction Helper:** `replicate_client_issue(service_config_from_client)` → suggests a minimal lab setup to mimic client issues

### **2. Optical Specialist & Docs MCP Server (The "Dev Teacher")**

:::tip Server Role: Developer Knowledge Base
This server provides knowledge tailored for a developer audience, including API docs and best practices.
:::
...
This scenario demonstrates how a junior developer uses the AI Copilot to quickly set up and configure a new feature implementation.
:::
...
This example shows how testers can quickly replicate customer issues in the lab environment.
:::
